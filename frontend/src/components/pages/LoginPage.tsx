        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
            <div className="max-w-md w-full mx-4">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-400 mt-2">Learn code by exploring real projects</p>
                </div>
                ...
                <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-slate-700/50">
                    ...
                    <div className="mt-6 p-3 bg-slate-700/30 rounded-lg">
                        <p className="text-xs text-slate-400 text-center">
                            Demo: <span className="text-slate-300">test@example.com</span> / <span className="text-slate-300">test123</span>
                        </p>
                    </div>
                </div>
            </div>
